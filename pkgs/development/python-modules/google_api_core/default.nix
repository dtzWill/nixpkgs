...
, google_auth, protobuf3_12, googleapis_common_protos, requests, setuptools, grpcio
, mock
}:
...
buildPythonPackage rec {
  ...
  src = fetchPypi {
    ...
    sha256 = "1xhlgc0jv2a39yij6264rwzdwnvc9p98hjbhwamxs1l40qsa9agy";
  };

  propagatedBuildInputs = [
    googleapis_common_protos protobuf3_12

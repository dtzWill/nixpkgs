...
let
  ...
  openjdk = stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      ...
      sha256 = "1ndlxmikyy299z7lqpr1bd0zxq7yx6xidj8y3c8mw9m9fy64h9c7";
    };
    ...
    buildInputs = [
      ...
      libXi libXinerama libXcursor libXrandr fontconfig openjdk12
    ...
    disallowedReferences = [ openjdk12 ];

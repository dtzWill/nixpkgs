...
let
  sources = {
    ...
    "aws-sdk-2.748.0" = {
      ...
      version = "2.748.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.748.0.tgz";
        sha512 = "H+DCioQ4AChoBxGMtagcJ3a0mM0lOh3ta/dWIrfPTECAlRIuxlrBDp78cRhPgvdYYUxW54kB/IaHGR2xPP8JXw==";
      };
    };
    "aws-sign2-0.7.0" = {
      name = "aws-sign2";

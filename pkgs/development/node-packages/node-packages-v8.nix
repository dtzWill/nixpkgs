...
let
  sources = {
    ...
    "aws-sdk-2.465.0" = {
      ...
      version = "2.465.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.465.0.tgz";
        sha512 = "eS3g80QUbhOo0Rd/WTudtlc4cuNpLget6Re1KyDod6319QvW2il1q28VyvZK0/Yiu8GyVh5xGbThaLEQem+fLQ==";
      };
    };
    "aws-sign2-0.6.0" = {
      name = "aws-sign2";

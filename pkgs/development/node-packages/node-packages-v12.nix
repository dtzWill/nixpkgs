...
let
  sources = {
    ...
    "terminal-kit-1.31.1" = {
      ...
      version = "1.31.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/terminal-kit/-/terminal-kit-1.31.1.tgz";
        sha512 = "mKPPkvRgUAuerK/bcZze6GLl8Y8C/agPncFsgR9zwIcz/2xPydcng9hbB48tYz6jrY3IXumi6WkaEYYYyzYtWQ==";
      };
    };
    "tkwidgets-0.5.26" = {
      name = "tkwidgets";

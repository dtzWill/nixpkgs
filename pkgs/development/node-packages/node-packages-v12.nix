...
let
  sources = {
    ...
    "string-kit-0.9.8" = {
      ...
      version = "0.9.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/string-kit/-/string-kit-0.9.8.tgz";
        sha512 = "YeopT4RBJrj0Cp2Cg9CieiT06jbMwqsVL+Zs4WlxCk7pgnhFR6FT+I8a3B3Y5nparJM9SFHMIbTFp9TeboEkZw==";
      };
    };

...
let
  sources = {
    ...
    "terminal-kit-1.29.1" = {
      ...
      version = "1.29.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/terminal-kit/-/terminal-kit-1.29.1.tgz";
        sha512 = "7Qv1OnNriQYf88JJPP9q483q1p7wGzcHfftd6sHFbnRs9/MSRRSJlxvOkIaa4MJZz/HH7yf12xtiNttu5FhAWA==";
      };
    };
    "tkwidgets-0.5.26" = {
      name = "tkwidgets";

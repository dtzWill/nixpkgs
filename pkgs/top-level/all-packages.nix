...
in
{
  ...
  gephi = callPackage ../applications/science/misc/gephi { jdk = jdk11; };
 ...
 #   inherit (python2Packages) python;
  ...
  zgrviewer = callPackage ../applications/graphics/zgrviewer { jre = jdk11; };
  ...
  */
  ...
  vnote = libsForQt59.callPackage ../applications/office/vnote { };

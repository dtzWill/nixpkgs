...
in
{
  ...
  fontforge-gtk-git = callPackage ../tools/misc/fontforge/git.nix {
    withSpiro = true;
    withGTK = true;
    inherit (darwin.apple_sdk.frameworks) Carbon Cocoa;
  };
  ...
  rpm = callPackage ../tools/package-management/rpm { python = python3; };
  ...
  crossLibcStdenv = overrideCC stdenv
    (if stdenv.targetPlatform.useLLVM or false
     then buildPackages.llvmPackages_latest.lldClangNoLibc
  ...
  gnumake43 = callPackage ../development/tools/build-managers/gnumake/4.3 { };
  gnumake = gnumake42;
  ...
  texinfo65 = callPackage ../development/tools/misc/texinfo/6.5.nix { };
  texinfo66 = callPackage ../development/tools/misc/texinfo/6.6.nix { };
  texinfo = texinfo6;
  texinfo6 = texinfo65; # texinfo66;
  ...
  gephi = callPackage ../applications/science/misc/gephi { jdk = jdk12; };
  ...
  # TODO: put the top-level attr somewhere sane
  ...
  mkLibsForQt5 = self: with self; {
    ...
    inherit (kdeFrameworks.override { libsForQt5 = self; })
      ...
      syndication threadweaver kirigami2 kholidays kpurpose kcontacts qqc2-desktop-style;
 ...
 #   inherit (python2Packages) python;
  ...
  bedstead  = callPackage ../data/fonts/bedstead { };
  ...
  libgnt = callPackage ../applications/networking/instant-messengers/pidgin/libgnt.nix { };
  ...
  udocker = python3Packages.callPackage ../tools/virtualization/udocker { };

  uefitoolPackages = recurseIntoAttrs (callPackage ../tools/system/uefitool/variants.nix {});
  uefitool = uefitoolPackages.new-engine; # unstable; # new-engine;
  ...
  bitcoin  = libsForQt5.callPackage ../applications/blockchains/bitcoin.nix { miniupnpc = miniupnpc_2; withGui = true; boost = boost171; };
  bitcoind = callPackage ../applications/blockchains/bitcoin.nix { miniupnpc = miniupnpc_2; withGui = false; boost = boost171; };
  ...
  gnomeExtensions = recurseIntoAttrs {
    ...
    # DTZ: restore these, don't have these commits yet

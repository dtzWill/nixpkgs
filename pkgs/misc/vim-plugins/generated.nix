  ...
  packages = ( self:
{
  ...
  asyncomplete-lsp-vim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1b93ef2d527e64a55d3b45d370ed59d6aa967fef";
      sha256 = "0a0kjb0f3qxsk2h58zx9s923xrw6cyw79hjbi41awly3cb29fral";
    };
  };
  ...
  asyncomplete-vim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      ...
      rev = "52f857a4c4c51abf6b29f4ce0b3db0aae992f619";
      sha256 = "14g69n324agscz2l5xza53cnpwd05i6zy8f53syd9qn0gl487wzz";
    };
  };
  ...
  coc-texlab = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "fannheyward";
      repo = "coc-texlab";
      rev = "f57ef0d8a4cf4233510f6c95527f488474ab059b";
      sha256 = "0wcqhiq10qxrm2p5dwpdbsg9v3xh9az0ky7sz2z41987h4iy3d4f";
    };
  };
  ...
  edge = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "sainnhe";
      repo = "edge";
      rev = "c863e04fcd482f4768c4a231efe7592cd54e99a5";
      sha256 = "0g9j4vkpffv74m79nrmq5j7xhfyzx2jxa1ffncvy2ql5pdx5vgmj";
    };
  };
  ...
  julia-vim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "JuliaEditorSupport";
      repo = "julia-vim";
      rev = "012c1086ca573cb5dd3ac00acde0adf327430c5b";
      sha256 = "1myb1c4l76w4zwn0nw2z803cq858yh7phpkih9fl3p2pddv43isd";
    };
  };
  ...
  onedark-vim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "joshdick";
      repo = "onedark.vim";
      rev = "e00c7b40eece40d49d15a1c3d6e88e351f64b3c9";
      sha256 = "09is8118l2lq406kja56amjk3sncagf5hi4hx0rfrvjc866ysngs";
    };
  };
  ...
  typescript-vim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "leafgarland";
      repo = "typescript-vim";
      rev = "bec15a2f6adaeb0fb026f1262cb4392024a02a9a";
      sha256 = "01vc7xm29bc3b4hkw1cz81jmgl8f51rk49cl0qhf0bqs0zwhr457";
    };
  };
  ...
  vim-darkspace = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "niklas-8";
      repo = "vim-darkspace";
      rev = "c3a0bc41ae21de2d2b0e674596f97255c74bf8fd";
      sha256 = "0z7v5k7zfw3z4b8fpvrazflqai9rbwpwwnjm243plj35k7snkgvk";
    };
  };
  ...
  vim-lsp = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "prabirshrestha";
      repo = "vim-lsp";
      rev = "20d1cf3968e5c3fbd880ef32202930f68d93a2da";
      sha256 = "0ckkgaa33kc6knvhzxdhggdiaivx6srqxcfyjms4mywgdzvj11l6";
    };
  };
  ...
  vim-moonfly-colors = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      ...
      rev = "73dacdd45601fdd755ac9f8b4d345470e09a5b9d";
      sha256 = "00x1qgaz9yj5kyh4097fp5vg9dl0ri5nzbjj4hlgi1rncnpqdi0h";
    };
  };
  ...
  vim-nightfly-guicolors = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b93e2f0c7f7e30ef9f02b405aea442711dc36f44";
      sha256 = "0b4243nibpxbri4cvikgw5qfjyxf682qa5hrmqma0dn1c8kz628h";
    };
  };
  ...
  vim-prettier = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "prettier";
      repo = "vim-prettier";
      rev = "bf17b2dd12c173c981bcdb72ecab0b2ad712bf59";
      sha256 = "1asbn4abkb8q5qnvyjy1d2j6qxnwyldp7gry7yzhvshmd3ngk4kz";
    };
  };

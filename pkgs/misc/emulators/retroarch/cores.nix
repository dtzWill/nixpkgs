...
, alsaLib, fluidsynth, curl, hidapi, libGLU, libGL, gettext, glib, gtk2, portaudio, SDL
...

{
  ...
  dolphin = (mkLibRetroCore {
    ...
    extraBuildInputs = [
      cmake curl libGLU libGL pcre pkgconfig sfml miniupnpc
  ...
  ppsspp = (mkLibRetroCore rec {
    ...
    license = gpl2;
    extraBuildInputs = [ libGLU libGL ffmpeg ];
  }).override {
    buildPhase = "cd libretro && make";
  };

...
, gpart, hdparm, procps, utillinux, polkit, wrapGAppsHook, substituteAll, yelp_tools
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ parted glib libuuid gtkmm3 yelp_tools libxml2 hicolor-icon-theme polkit.bin gnome3.adwaita-icon-theme  ];

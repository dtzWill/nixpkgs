...
, gnugrep, parted, glib, libuuid, pkgconfig, gtkmm3, libxml2, yelp_tools
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ parted glib libuuid gtkmm3 yelp_tools libxml2 polkit.bin gnome3.adwaita-icon-theme  ];
